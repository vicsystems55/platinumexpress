                ...
                <li class="nav-item">
                    ...
                    <div class="collapse show" id="navbar-examples">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link {{ (request()->is('admin/gurantors')) ? 'active' : '' }}" href="{{ route('admin.gurantors')}}">
                                    {{ __('Gurantors Accounts') }}
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link {{ (request()->is('admin/staff')) ? 'active' : '' }}" href="{{ route('admin.staff')}}">
                                    {{ __('Staff Accounts') }}
                                </a>
                            </li>
                        </ul>
